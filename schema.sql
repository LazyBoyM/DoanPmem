...
-- Chọn database test trong SQL Editor trước khi chạy.
-- Hệ QT CSDL: MySQL 8.0+
-- ==========================================================

-- Không đổi database tự động. Chạy toàn bộ file trong database đã chọn.
-- Khuyến nghị: cd server && npm run db:setup (đọc server/.env).
